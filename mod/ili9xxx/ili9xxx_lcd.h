...
#if !ILI9341
#define ILI9XXX_SCREEN_WIDTH  220
#define ILI9XXX_SCREEN_HEIGHT 176
#else
// currently, the ili9341 is only supported in portrait mode as
// it's to be mounted using a 2.8 inch display in a lego gameboy
#define ILI9XXX_SCREEN_WIDTH  240
#define ILI9XXX_SCREEN_HEIGHT 320
#endif

#define ILI9XXX_SCREEN_YOFFSET -52   // y offset to make display off-center

// enable scaling if useful
#define ENABLE_XSCALE_1_5      // enable x1.5 horizontal scaling

// When scaling we need to generate intermediate pixel levels. This
// doesn't work nicely with colormaps
#ifdef ENABLE_XSCALE_1_5
#define NO_COLORMAPPING
#endif
