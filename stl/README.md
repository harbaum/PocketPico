...
The direction pad needs to accommodate four tactile switches.

![Image of DPad support](./dpad_support.png)

Download the [STL file for the DPad support](./dpad_support.stl).

## A/B buttons

The A and B buttons sit inside those round Lego container
pieces and get one button support part each.

![Image of A/B support](./button_a_b_support.png)

Download the [STL file for the A/B buttons support](./button_a_b_support.stl).

## Start/Select buttons

The start and select buttons use one common part to support both tactile
switches. Currently, it's designed to be used with a 2x1 plate instead of
the round wheel originally being used in the model.

![Image of Start/Select support](./button_start_select_support.png)
...
![Image of USB-C fake cartridge charger](./cartridge_usb_c_charger.png)
